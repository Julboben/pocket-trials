...
import {
  ...
  XPBD_UPHILL_FORWARD_LEAN_REDUCTION, XPBD_UPHILL_ANTI_WHEELIE_ACCELERATION,
...
assert.equal(XPBD_UPHILL_ANTI_WHEELIE_ACCELERATION, 0, 'throttle pitch must come from motor reaction, not an anti-wheelie helper');
